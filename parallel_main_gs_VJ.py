...
def main(sample):
    ...
    f = pyfits.open(base+"fields/gs_presm4_all_acs_f606w_60mas_v3.0_rms.fits")
    rms1_data=f[0].data
    ...
    f = pyfits.open(
        base+"fields/gs_presm4_all_acs_f606w_60mas_v3.0_drz_psfmatch2h_p01.fits")
    ...
    while not done:
        if( len(threads) < num_processes-1):
            ...
            f1 = open("galaxy"+str(galaxy_num).zfill(5)+"_gs_VJ.txt","wt")
...
def work(naxes,rms1,rms2,image1,image2,segmap,x_coor,y_coor,galaxy_num,f1):
    ...
    rms1 = convert(rms1,rms1_c,naxes,'V')
    rms2 = convert(rms2,rms2_c,naxes,'J')
    image1 = convert(image1,image1_c,naxes,'V')
    image2 = convert(image2,image2_c,naxes,'J')
