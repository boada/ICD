...
def main(sample):
    ...
    base='/home/steven/Projects/image_fields/CANDELS/GOODS_S_only/'

    f = pyfits.open(base+"fields/gs_acs_old_f775w_060mas_v2_rms.fits")
    rms1_data=f[0].data

    f = pyfits.open(
            base+"fields/gsd_all_4epoch_wfc3_f160w_060mas_v0.3_rms.fits")
    rms2_data=f[0].data

    f = pyfits.open(base+"fields/gs_acs_old_f775w_060mas_v2_drz.fits")
    ...
    #base='/home/steven/Projects/image_fields/CANDELS/GOODS_S_complete/'
    #f = pyfits.open(
    ...
    while not done:
        if( len(threads) < num_processes-1):
            ...
            f1 = open("galaxy"+str(galaxy_num).zfill(5)+"_gsonly_IH.txt","wt")
