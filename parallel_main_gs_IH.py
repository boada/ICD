...
def main(sample):
    ...
    f = pyfits.open(base+"fields/gs_presm4_all_acs_f775w_60mas_v3.0_rms.fits")
    rms1_data=f[0].data
    ...
    f = pyfits.open(
            base+"fields/gs_presm4_all_acs_f775w_60mas_v3.0_drz_psfmatch2h_p01.fits")
    ...
    while not done:
        if( len(threads) < num_processes-1):
            ...
            f1 = open("galaxy"+str(galaxy_num).zfill(5)+"_gs_IH.txt","wt")
