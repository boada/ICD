...
icd = pyl.asarray([galaxy.ICD_IH*100 for galaxy in galaxies if galaxy.ICD_IH >
    0.5])
colorgrad = pyl.asarray([galaxy.Color_grad for galaxy in galaxies if
    galaxy.ICD_IH > 0.5])

f1s1.scatter(50*pyl.ones(len(colorgrad)), colorgrad, s=100, marker=None, verts = arrow_right)
