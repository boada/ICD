...
y_median = pyl.asarray(y_median)[:-4]
y_upper = pyl.asarray(y_upper)[:-4]
y_low = pyl.asarray(y_low)[:-4]
x_ = x_[:-4]
...
f1s1.axvline(1.46, ls='--', lw=2)
f1s1.text(1.37, 26, 'WFC3 PSF FWHM', rotation='vertical', va='bottom')
