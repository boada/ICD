...
# Last Change: Wed Feb 13 16:27:39 2013
...
pyl.bar(1.5,low_1/total_1,width=0.5, ec='k', fc='b', \
    label=r"$0.04 \leq \xi[I,H] \leq 0.11$",bottom=bot1)
...
pyl.bar(1.5,med_1/total_1,width=0.5, ec='k', fc='r', \
    label=r"$0.11 \leq \xi[I,H] \leq 0.18$",bottom=bot1)
...
pyl.bar(1.5,high_1/total_1,width=0.5, ec='k', fc='g', \
    label=r"$0.18 \leq \xi[I,H] \leq 0.25$",bottom=bot1)
